...
void GameManager::displayStartPage()
{
    ...
    ioManager.write("Welcome to VoidQuest, a text-based fantasy RPG! To play, enter the letter of the option you want "
                    "to choose. \n");
...
void GameManager::startSceneLogic(const std::string &firstSceneKey)
{
    ...
    // startSceneManager
    while (sceneManager.getCurrentScene() != nullptr)
    {
